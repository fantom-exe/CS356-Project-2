...
public class UserView extends javax.swing.JFrame {
    ...
    final DefaultListModel<String> followingModel = new DefaultListModel<>();
    final DefaultListModel<String> newsFeedModel = new DefaultListModel<>();

    public UserView(User user, Component root) {
        this.user = user;
        this.root = root;
        initComponents();
        setTitle("User View for " + user);
